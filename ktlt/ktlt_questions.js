...
const ktltQuestions = [
  ...
  {id:108,ky:"ktlt_on",label:"Ôn tập KTLT",
   text:"Đoạn mã nào đọc và in ký tự đến cuối tệp, đúng và phong cách tốt?&lt;br&gt;&lt;pre&gt;&lt;code&gt;// #1: while (c = getchar() != EOF) putchar(c);\n// #2: while ((c = getchar()) != EOF) putchar(c);\n// #3: while (c = (getchar() != EOF)) putchar(c);\n// #4: while (c == (getchar() != EOF)) putchar(c);&lt;/code&gt;&lt;/pre&gt;",
   options:[
       "Đoạn #1",
       "Đoạn #2",
       "Đoạn #3",
